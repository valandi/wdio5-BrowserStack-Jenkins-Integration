...
async function sh(command, options) {
    return await executeProcess('/bin/bash', ['-c', command], Object.assign(Object.assign({}, options), { spawnOptions: Object.assign({ stdio: 'inherit' }, options === null || options === void 0 ? void 0 : options.spawnOptions) }));
}
exports.sh = sh;
