...
class Eyes {
    constructor(runnerOrConfig, config) {
        ...
        this._logger = new Logger_1.Logger(Object.assign(Object.assign({}, this._config.logs), { label: 'Eyes API' }));
    }
    get _spec() {
    ...
    async close(throwErr = true) {
        ...
        if (!this.isOpen)
            throw new EyesError_1.EyesError('Eyes not open');
        const deleteTest = (options) => this._spec.deleteTest(Object.assign(Object.assign({}, options), { serverUrl: this._config.serverUrl, apiKey: this._config.apiKey, proxy: this._config.proxy }));
        try {
    ...
    async abort() {
        ...
        return this._eyes
            .abort()
            .then(([result]) => {
            return new TestResults_1.TestResultsData(result, options => this._spec.deleteTest(Object.assign(Object.assign({}, options), { serverUrl: this._config.serverUrl, apiKey: this._config.apiKey, proxy: this._config.proxy })));
        })
